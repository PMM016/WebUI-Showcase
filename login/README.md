<div align="center">
  <h1>Login Templates Collection</h1>
  
  <p><strong>Modern • Beautiful • Highly Customizable</strong></p>
  ...
  A premium collection of stunning single-file login pages perfect for SaaS, dashboards, apps, and portfolios.
  
  ![Hero Banner](https://via.placeholder.com/1200x400/1a1a2e/00ffcc?text=Login+Templates+Collection)
</div>
